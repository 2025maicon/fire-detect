...
아까 팀장님이랑 이야기 나눈 방식으로 일단 만들어 보았습니다. 
이 코드를 살리거나 죽이거나 어떤 방식이든 상관 없습니다.. 혹여나 더 좋은 방법이 있다면 가차없이 버려도 괜찮습니다. 화재감지 관련 내용을 두 분께 맡기고 자러 가보겠습니다.. 
학습은 아까 드론으로 촬영한 영상 데이터로 해 놓았습니다. 이 파일에는 아직 추가하지 않았고, 메인 컴퓨터에 있을겁니다. 화재건물만을 라벨링해 학습을 진행했기 때문에 추가 데이터 및 학습이 필요하다면 연습용 경기장에서도 수급이 가능할 것 같습니다.
